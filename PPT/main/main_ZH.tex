...
\begin{frame}{个人简介}
  \begin{itemize}
    ...
    \item 曾获高中全国物理竞赛省一等奖 (实验部分全省第 8 名), 自学大学与研究生阶段物理课程.
  \end{itemize}
\end{frame}
...
\begin{frame}{有限元方法简介}
  ...
  \begin{figure}[htbp]
    \centering
    \includegraphics[width=.6\textwidth]{figure/basis.png} \includegraphics[width=.25\textwidth]{figure/grid.jpg}
...
\begin{frame}{实验结果}
  \begin{itemize}
    ...
    \item Final paper was accepted by \textit{Journal of Scientific Computing}.
  \end{itemize}
  \begin{figure}[htbp]
    \centering
...
\begin{frame}{总结}
  \begin{itemize}
    ...
    \item 积极乐观, 热爱研究并能主动探索. \\ \
    \item 希望有机会能在中文信息处理实验室继续提升自己.
  \end{itemize}
  \begin{figure}[htbp]
    \centering
